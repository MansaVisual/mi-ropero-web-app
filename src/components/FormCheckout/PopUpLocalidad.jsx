        ...
        <div className="setSucursales">
          ...
          <div className="popUp">
                ...
                return (
                  <div
                    ...
                    className={`cardSucursal ${
                      infoLocFinal === loc.IdCentroImposicion && "selected"
                    }`}
                    onClick={() => setInfoLocFinal(loc)}
                  >
                    <Radio
                      name="localidad"
                      id={loc.idlocalidad}
                      checked={
                        infoLocFinal.length !== 0 &&
                        infoLocFinal.idlocalidad === loc.idlocalidad
                          ? true
                          : false
                      }
                    />
            ...
            <Button
              ...
              disabled={infoLocFinal.length === 0 ? true : false}
              onClick={() => {
                setPopLoc(false);
              }}
            >
