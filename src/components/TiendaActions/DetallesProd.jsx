...
const DetallesProd = () => {
    ...
    const [detalles,setDetalles]=useState({title:"",precio:0,descripcion:""})
    ...
    useEffect(() => {
        if(detalles.title!=="" && detalles.precio!==0 && detalles.descripcion!==""){
            setHabilitado(true)
        }
    }, [detalles]);
    ...
    <div className="detallesProdContainer">
      <div className="container">
        ...
        <Box sx={{display:"flex",justifyContent:"space-between",alignItems:"flex-end"}}>
            ...
            <span className="titleRight" onClick={()=>setOpenDescPopUp(true)}>CREAR DESCUENTO PARA PRODUCTO</span>
        </Box>
        ...
        <div className="returnLink" onClick={() => navigate(`/MiTienda/IMAGENES`)}>
