    ...
    <Box>
      ...
      <Box sx={{maxWidth:"1366px",display:"flex",flexDirection:"column",margin:"auto",justifyContent:"center",overflowX:"hidden"}}>
        ...
        <Box className="page404">
            ...
            <p className="p1">La página que estás buscando no está disponible en este momento.</p>
            <p className="p2">Si necesitas ayuda, podés <span className="span">contactarte</span> con nosotros.</p>
